...
export function OrdenamientoRegistros() {
    ...
    registrosOrdenados.sort((a, b) => {
      if (totalVacantes !== "") {
        if (a.totalVacantes !== b.totalVacantes) {
          return a.totalVacantes - b.totalVacantes;
        }
      }
  ...
  <div className="flex items-center mb-4">
    ...
    <button onClick={handleSearch} className="bg-terciary-color hover:bg-orange-color text-white px-4 py-2 rounded-md ml-4"
>
      Ordenar
    </button>
  </div>
